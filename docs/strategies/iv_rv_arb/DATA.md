...
> Documentation location: repository `docs/`. Source code remains in `strategies/iv_rv_arb/data`. Shell commands retain their stated working directory.

Drop static historical files into repository `strategies/iv_rv_arb/data/`; `data.load_okx_btc` parses them into the same
