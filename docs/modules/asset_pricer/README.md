...
> Documentation location: repository `docs/`. Source code remains in `asset_pricer`. Run module-relative commands from the source `asset_pricer/` directory; commands explicitly marked repository-root remain rooted there.
