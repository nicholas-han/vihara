...
需要注意，仓库同时保留了早期 PostgreSQL 设计以及 v3 文件持久化方案。发生冲突时，以 `docs/modules/instrument_manager/75-file-persistence.md`、ADR-24/25 和当前实现为准。
...
- `docs/modules/instrument_manager/README.md`
- `docs/modules/instrument_manager/75-file-persistence.md`
