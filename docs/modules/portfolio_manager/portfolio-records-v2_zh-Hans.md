...
> Legacy records 文档，不适用于当前 Holdings。当前架构与账户模型见 [Holdings 项目](../../projects/portfolio-holdings/README.md)。
...
导入格式(交易 / 分红 / 汇率)见 `docs/modules/portfolio_manager/import-format-v1_zh-Hans.md`;
