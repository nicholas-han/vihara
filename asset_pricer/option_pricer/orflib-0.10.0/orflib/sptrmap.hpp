...
public:
  typedef typename std::shared_ptr<T> ptr_type;
  typedef typename std::pair<ptr_type, unsigned long> pair_type;
  typedef typename std::map<std::string, pair_type> map_type;
