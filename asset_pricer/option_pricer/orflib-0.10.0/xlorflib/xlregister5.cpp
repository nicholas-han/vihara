...
namespace {
  ...
  XLRegistration::Arg OrfMeanVarWghtsArgs[] = {
	  { "AssetRets", "expected asset returns within the holding period", "XLF_OPER" },
	  { "AssetVols", "volatility of returns within the holding period", "XLF_OPER" },
	  { "CorrMat", "correlation matrix of asset returns", "XLF_OPER" },
	  { "Lambda", "risk aversion parameter", "XLF_OPER" }
  };
  XLRegistration::XLFunctionRegistrationHelper regOrfMeanVarWghts(
	  "xlOrfMeanVarWghts", "ORF.MEANVARWGHTS", "Weights of the mean variance optimized portfolio.",
  ...
  XLRegistration::Arg OrfMeanVarFrontArgs[] = {
	  ...
	  { "AssetVols", "volatility of returns within the holding period", "XLF_OPER" },
	  { "CorrMat", "correlation matrix of asset returns", "XLF_OPER" },
	  { "LambdaMax", "Maximum risk aversion parameter", "XLF_OPER" },
	  { "NLambdaSteps", "steps for lambda", "XLF_OPER" },
	  { "Headers", "TRUE for displaying the header", "XLF_OPER" }
  };
  XLRegistration::XLFunctionRegistrationHelper regOrfMeanVarFront(
	  "xlOrfMeanVarFront", "ORF.MEANVARFRONT", "Mean return, std. deviation and lambda of the mean-variance.",
	  "ORFLIB", OrfMeanVarFrontArgs, 6);

  // Register the function ORF.TGTWGHTS
	  XLRegistration::Arg OrfTgtWghtsArgs[] = {
		  { "AssetRets", "expected asset returns within the holding period", "XLF_OPER" },
		  { "AssetVols", "volatility of returns within the holding period", "XLF_OPER" },
		  { "CorrMat", "correlation matrix of asset returns", "XLF_OPER" },
		  { "ExpectedReturn", "Fixed expected return", "XLF_OPER" },
  };
  XLRegistration::XLFunctionRegistrationHelper regOrfTgtWghts(
	  "xlOrfTgtWghts", "ORF.TGTWGHTS", "Weights of the minimum variance portfolio.",
	  "ORFLIB", OrfTgtWghtsArgs, 4);
