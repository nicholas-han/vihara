  ...
  for (RW i = 0; i < nr; ++i) {
    ...
    if (paramname == "URNGTYPE") {
      ...
      if (paramvalue == "MINSTDRAND")
        mcparams.urngType = McParams::MINSTDRAND;
      else if (paramvalue == "MT19937")
        mcparams.urngType = McParams::MT19937;
      else if (paramvalue == "RANLUX3")
        mcparams.urngType = McParams::RANLUX3;
      else if (paramvalue == "RANLUX4")
        mcparams.urngType = McParams::RANLUX4;
      else if (paramvalue == "SOBOL")
        mcparams.urngType = McParams::SOBOL;
      else
      ...
      std::transform(paramvalue.begin(), paramvalue.end(), paramvalue.begin(), ::toupper);
      if (paramvalue == "EULER")
        mcparams.pathGenType = McParams::EULER;
      else if (paramvalue == "BROWNIANBRIDGE")
        mcparams.pathGenType = McParams::BROWNIANBRIDGE;
      else
        ORF_ASSERT(0, "xlOperToMcParams: invalid value for McParam " + paramname + "!");
    }
    else
