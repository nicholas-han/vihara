...
namespace {
  ...
  // Register the function ORF.BERMBSPDE
  XLRegistration::Arg OrfBermBSPDEArgs[] = {
	  { "PayoffType", "1: call; -1: put", "XLF_OPER" },
	  { "Strike", "strike", "XLF_OPER" },
	  { "TimesToExer", "times to exercise", "XLF_OPER" },
	  { "Spot", "spot", "XLF_OPER" },
	  { "DiscountCrv", "name of the discount curve", "XLF_OPER" },
	  { "DivYield", "dividend yield (cont. cmpd.)", "XLF_OPER" },
	  { "Vol", "volatility", "XLF_OPER" },
  ...
  XLRegistration::XLFunctionRegistrationHelper regOrfBermBSPDE(
	  "xlOrfBermBSPDE", "ORF.BERMBSPDE", "Price of a Bermudan option in the Black-Scholes model using PDE.",
	  "ORFLIB", OrfBermBSPDEArgs, 9);
