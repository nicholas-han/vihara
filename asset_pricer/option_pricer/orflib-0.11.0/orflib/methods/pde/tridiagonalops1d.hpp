...
inline
TridiagonalOp1D<ARRAY>
operator+(TridiagonalOp1D<ARRAY> const& a,
TridiagonalOp1D<ARRAY> const& b)
{
...
inline
TridiagonalOp1D<ARRAY>
operator-(TridiagonalOp1D<ARRAY> const& a, TridiagonalOp1D<ARRAY> const & b)
{
...
TridiagonalOp1D<ARRAY> const& rhs)
{
